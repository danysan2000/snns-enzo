...
DANYSAN:
	Horrible como esta escrito el programa original
	lo paso por el indent.
*/
...
static PyObject *snns_int_arg_with_err(PyObject *arg, int_arg_with_err_func func)
{
	long num;
	krui_err err;
...
static PyObject *snns_string_arg_with_err(PyObject *arg, string_arg_with_err_func func)
{
	char *text=NULL;
	krui_err err;
...
static PyObject *wrap_pattern_set_info(pattern_set_info *ps, char *attr)
{
	PyObject *ret = NULL;
	int i, failures=0;
...
static PyObject *wrap_pattern_descriptor(pattern_descriptor *pd, char *attr)
{
	PyObject *ret=NULL;
	int i, failures=0;
...
static PyObject *pattern_set_info_getattr(PyObject *o, PyObject *attrname)
{
	return wrap_pattern_set_info(&((snns_pattern_set_info_object *)o)->psi, (char *) PyUnicode_AsUTF8(attrname));	
}

static PyObject *pattern_descriptor_getattr(PyObject *o, PyObject *attrname)
{
...
static PyObject *snns_error(PyObject *self, PyObject *arg)
{
	int num;
...
static PyObject *snns_getVersion(PyObject *self, PyObject *arg)
{
	return Py_BuildValue("s",krui_getVersion());
}

static PyObject *snns_saveNet(PyObject *self, PyObject *args)
{
	char *netname;
	char *filename;
	krui_err err;
	if(PyArg_ParseTuple(args,"sz",&filename,&netname) && (err=krui_saveNet(filename,netname)))
	{
		return make_exception(err);
	}
...
static PyObject *snns_loadNet(PyObject *self, PyObject *name)
{
	char *netname=NULL;
	char *filename;
	krui_err err;
...
static PyObject *snns_getNetInfo(PyObject *self, PyObject *arg)
{
...
static PyObject *snns_getMemoryManagerInfo(PyObject *self, PyObject *arg)
{
	int ubytes, sbytes,lbytes,ntbytes,stbytes,ftbytes;
	
	krui_getMemoryManagerInfo(&ubytes,&sbytes,&lbytes,&ntbytes,&stbytes,&ftbytes);	

	return Py_BuildValue("(iiiii)",ubytes,sbytes,lbytes,ntbytes, stbytes,ftbytes);
}

static PyObject *snns_getSymbolTable(PyObject *self, PyObject *arg)
{
	PyObject *ret;
	char *name;
	int val;
...
static PyObject *snns_deleteNet(PyObject *self, PyObject *arg)
{
	krui_deleteNet();
	return Py_BuildValue("");
}
...
static PyObject *snns_int_char_args_with_err(PyObject *args, snns_int_char_args_with_err_func func)
{
	krui_err err;
	int i;
	char *c;
	if(!PyArg_ParseTuple(args,"is",&i,&c)) 
		return NULL;
	err = func(i,c);
	if(err)
		return make_exception(err);
...
static PyObject *snns_setUnitOutFunc(PyObject *self, PyObject *args)
{
